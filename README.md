...
1. How would you describe accessibility on the web to someone new to programming?
   ...
   - Accessibility on the web is the idea that websites should be created in a way that people with certain disabilities are able to freely access and explore the content on the web.

2. Talk about 3 different things you can do to ensure your website is accessible.

   1. Ensure you are using semantic HTML.
   2. Use Alt tags.
   3. Use colors and styling that have high contrast and are easy to read.

3. How would you explain the concept of a variable to someone new to programming?

   - A variable is a name or tag that is used to identify information. A variable is like a "container" or it represents the information assigned to it.

4. What is the purpose of using functions in code?

   - The purpose of a function is to perform a task.
